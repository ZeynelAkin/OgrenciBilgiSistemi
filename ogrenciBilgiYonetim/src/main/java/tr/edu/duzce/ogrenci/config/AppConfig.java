...
public class AppConfig implements AvailableSettings {
    ...
    public LocalSessionFactoryBean getSessionFactory() {
        ...
        factoryBean.setAnnotatedClasses(FakulteModel.class, BolumModel.class, DanismanModel.class, OgrenciModel.class, LoginModel.class,Personel.class); //Model Sınıfları OgrenciModel.class, BolumModel.class, DanismanModel.class, FakulteModel.class
